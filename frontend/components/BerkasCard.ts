...
import { BerkasMagang, statusColors } from '../types.js';

export interface BerkasCardProps {
    berkas: BerkasMagang;
    showActions?: boolean;
    onVerifikasi?: (status: 'DITERIMA' | 'DITOLAK') => void;
    onDelete?: () => void;
}

export class BerkasCard {
    private container: HTMLElement;
    private props: BerkasCardProps;

    constructor(containerId: string, props: BerkasCardProps) {
    ...
    public updateProps(props: Partial<BerkasCardProps>): void {
